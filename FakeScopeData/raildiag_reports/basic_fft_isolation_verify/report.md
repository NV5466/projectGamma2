# ElectroStat Report: basic_fft_sanity_scope
...
## Channel Roles
### CH1_clean_1kHz_V
- Line identity: not supplied
- Role: unknown
- Signal type: unknown
- Voltage class: unknown
- Measurement reference: unknown
- Problem observed: unknown

### CH2_1kHz_3kHz_60Hz_noise_V
- Line identity: not supplied
- Role: unknown
- Signal type: unknown
- Voltage class: unknown
...
## Event Timeline
- No role-aware timeline events were detected. Add channel roles/signal types to enable routing.

## Analysis Windows
- No first-class analysis windows were generated.

## Role-Aware Interpretation
### CH1_clean_1kHz_V: CH1_clean_1kHz_V
- Route: unknown / unknown
- Routed analyses: basic_stats, waveform_plot, PSD_plot
- Role is unknown; analysis is limited to generic waveform/statistical evidence.
...
### CH1_clean_1kHz_V: CH1_clean_1kHz_V
- Role: unknown
- Warning: Many samples sit exactly at the channel min/max; check for analog clipping or quantization.
...
- Global PSD overview peaks: 1000.98 Hz, 24.4141 Hz
...
- Global PSD overview peaks: 1000.98 Hz, 3002.93 Hz, 48.8281 Hz, 12426.8 Hz, 4809.57 Hz
...
- Global PSD overview peaks: 488.281 Hz, 1489.26 Hz, 2490.23 Hz, 3491.21 Hz, 4492.19 Hz
...
- Global PSD overview peaks: 4199.22 Hz, 3442.38 Hz, 3369.14 Hz, 4931.64 Hz, 3222.66 Hz
